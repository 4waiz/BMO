...
- **Windows Piper voice missing**: run `scripts\bootstrap_and_run.ps1` again or download `en_US-lessac-medium.onnx` into `models\piper` and set the path in Settings
